...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -12701.510524701107; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 13048.964307250928; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 7764.1461652752605; // x position of the perpendicular encoder (in tick units)
    }
